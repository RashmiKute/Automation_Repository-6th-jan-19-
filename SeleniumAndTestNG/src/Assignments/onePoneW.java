...
public class onePoneW {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Select sel1=new Select(ele1);
				sel1.selectByVisibleText("Paris");
				...
				sel6.selectByVisibleText("8");
				dr.findElement(By.xpath("//input[@value='Business']")).click();
				Boolean b1=dr.findElement(By.xpath("//input[@value='Business']")).isSelected();
